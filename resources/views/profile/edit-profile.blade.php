@extends('navbar')
@section('title','Edit Profile | E-Budgeting')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ url('edit-profile/process') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="email_or_phone" class="form-label"><strong>Phone Number or Email</strong></label>
                    <input class="form-control" name="email_or_phone" placeholder="Enter your Phone Number or Email" value="{{ $data->email_or_phone }}">
