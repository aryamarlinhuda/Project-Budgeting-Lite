@extends('navbar')
@section('title','Profle | E-Budgeting')
@section('profile')
<div class="container">
    <div class="row mt-5">
        <div class="col-md-6 offset-md-3">
            <div class="card mt-4">
                ...
                @if($data->photo)
                    ...
                    <a href="delete-photo" class="btn btn-sm btn-danger float-end m-3 col-md-3">
                ...
                <div class="card-body text-center">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong>Phone Number or Email</strong><br>{{ $data->email_or_phone }}</li>
                    </ul>
                </div>
